...
app.get('/rss', async (req, res) => {
  try {
    ...
    const generationParams: FeedGenerationParams = {
      ...
      useReadability: searchParams.readability === 'true',
    ...
    endpoints: {
      ...
      '/rss': {
        ...
        parameters: {
          ...
          readability: 'Set to "true" to clean article content via Mozilla Readability (requires fetchContent=true, default: false)',
        },
